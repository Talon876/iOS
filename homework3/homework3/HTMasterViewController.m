...
// Good work, 100%. The code could use a little cleanup...
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (HTDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
